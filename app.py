...
def display_chat_message(role, content, sources=None):
    ...
    if role == "user":
        ...
        <div class="chat-message user-message">
            <strong style="color: #1f1f1f;">You:</strong> <div style="color: #1f1f1f; margin-top: 0.5rem;">{content_safe}</div>
        </div>
        """, unsafe_allow_html=True)
    else:
        sources_html = ""
        ...
        <div class="chat-message bot-message">
            <strong style="color: #1f1f1f;">🤖 Bot:</strong> <div style="color: #1f1f1f; margin-top: 0.5rem; line-height: 1.6;">{content_safe}</div>
            {sources_html}
        </div>
        """, unsafe_allow_html=True)
